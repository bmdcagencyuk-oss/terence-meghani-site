 ...
 *
 * Three.js + addons are dynamically imported inside useEffect so the ~500 kB
 * library is split into its own chunk and SSR stays clean.
 */
export function MorphingGorilla() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // Lighting rig — violet sky / charcoal ground hemi for ambience,
      // rocket-orange directional from upper right for warm key light, and
      // a magenta-violet point at origin filling the centre.
      ...
      // Placeholder — to be replaced by the particle system in Phase 2.
      ...
      // Subtle chromatic aberration — radial RGB split, near-imperceptible
      // on still frames but adds a premium feel during motion. Strength is
      // intentionally tiny (0.002) so it never reads as a defect.
      ...
      // Phase 5 adds a graceful static fallback; for now we just warn so the
      // rest of the hero still renders.
